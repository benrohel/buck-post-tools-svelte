...
export const defaultExportPresets: Exporter[] = [
  {
    ...
    "description":"This can be used for Buck Legacy folder structure. The root folder should be the Production folder.",
    "path": [
      {
        "id": "buck-legacy-shot",
        "type": "folder",
  ...
  },
  {
    ...
    "description":"The root folder should be a sequence folder inside production/shots",
    "path": [
      {
        "type": "folder",
        "name": "{shot}",
