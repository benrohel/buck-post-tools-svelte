<script lang="ts">
  ...
  let items = [
    { label: "Project", value: 1, component: ProjectContainer },
    { label: "Rename", value: 2, component: RenameContainer },
    { label: "Ingest", value: 3, component: IngestContainer },
    { label: "Export", value: 4, component: ExportContainer },
  ];
